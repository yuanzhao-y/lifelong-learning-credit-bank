...
| `llcb/develop` at final CI execution | `16bbf1ed9afc1265dc03001cf6a0fc96c83a800a` |
...
JaCoCo core coverage gate. Jenkins Build #8 archived the same artifact family
together with Surefire, JaCoCo and `test-evidence/**`; Jenkins fingerprints
provide the CI-side artifact identity.
