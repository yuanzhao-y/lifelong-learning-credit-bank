...
verified locally with `mvn -B clean verify`; the next Jenkins build will run the
same gate. The full-backend aggregate is intentionally not used as a pass/fail
